...
export default function Hero() {
  return <section id="top" className="hero"><div className="hero-copy"><p className="eyebrow"><i /> SOFTWARE ENGINEER / AI SYSTEMS</p><h1>Building the<br /><strong>intelligence</strong><br />behind tomorrow.</h1><p className="hero-text">I&apos;m Anirudha Kurhade — engineering Generative AI products and scalable data pipelines that turn complex systems into useful experiences.</p><div className="hero-actions"><a className="button" href="#work">Explore selected work ↗</a><a className="quiet-link" href="#contact">Let&apos;s connect</a></div></div><div className="hero-canvas"><Canvas camera={{ position: [0, 0, 4.5] }}><ambientLight intensity={.4} /><Particles /></Canvas><span className="canvas-label">GENERATIVE SYSTEM / 001</span></div><div className="scroll-note">SCROLL TO EXPLORE <span>↓</span></div></section>;
}
